    ...
    private void getRoute(final LatLng endPoint) {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                GoogleRouteApi googleRouteApi = new GoogleRouteApi(LocationActivity.this, startPoint, endPoint, new GoogleRouteApi.EventListener() {
                    @Override
                    public void onApiResult(String result) {
                        Toast.makeText(LocationActivity.this, "요청 성공", Toast.LENGTH_LONG).show();
                    ...
                    public void onApiFailed() {
                        Toast.makeText(LocationActivity.this, "요청을 실패하였습니다", Toast.LENGTH_LONG).show();
                    }
                });
